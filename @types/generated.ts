...
export type MarkdownRemarkFieldsFilterInput = {
  ...
  isBlogPost?: Maybe<BooleanQueryOperatorInput>;
};
...
export type MdFileSortInput = {
  fields?: Maybe<Array<Maybe<MdFileFieldsEnum>>>;
  order?: Maybe<Array<Maybe<SortOrderEnum>>>;
};
...
export type QueryAllMdFileArgs = {
  filter?: Maybe<MdFileFilterInput>;
  sort?: Maybe<MdFileSortInput>;
  skip?: Maybe<Scalars['Int']>;
  limit?: Maybe<Scalars['Int']>;
};
...
export type SiteSiteMetadataFilterInput = {
  ...
  authorEmail?: Maybe<StringQueryOperatorInput>;
  image?: Maybe<StringQueryOperatorInput>;
  organization?: Maybe<SiteSiteMetadataOrganizationFilterInput>;
  authorLinkedIn?: Maybe<StringQueryOperatorInput>;
  authorGitHubUsername?: Maybe<StringQueryOperatorInput>;
  authorGitHub?: Maybe<StringQueryOperatorInput>;
  authorTwitter?: Maybe<StringQueryOperatorInput>;
};
...
export type CategoryListingQuery = { allMarkdownRemark: { edges: Array<{ node: PostDataFragment }> } };

export type ChronListingQueryVariables = Exact<{ [key: string]: never; }>;


export type ChronListingQuery = { allMarkdownRemark: { edges: Array<{ node: PostDataFragment }> } };

export type LayoutQueryVariables = Exact<{ [key: string]: never; }>;


export type LayoutQuery = { file?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> };
...
export type SeoQuery = { site?: Maybe<{ siteMetadata?: Maybe<(
      Pick<SiteSiteMetadata, 'title' | 'description' | 'siteUrl' | 'image' | 'author' | 'authorEmail'>
      & { organization?: Maybe<Pick<SiteSiteMetadataOrganization, 'name' | 'url' | 'logo'>> }
    )> }> };

export type HomeQueryVariables = Exact<{ [key: string]: never; }>;


export type HomeQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'authorLinkedIn' | 'authorGitHub' | 'authorTwitter'>> }> };

export type ProjectsQueryVariables = Exact<{ [key: string]: never; }>;


export type ProjectsQuery = { site?: Maybe<{ siteMetadata?: Maybe<Pick<SiteSiteMetadata, 'authorLinkedIn' | 'authorGitHubUsername' | 'authorGitHub' | 'authorTwitter'>> }> };
